angular.module('orsApp.settings-service', [])
    .factory('orsSettingsFactory', ['$timeout', 'orsObjectsFactory', 'orsUtilsService', 'orsRequestService', 'orsRouteService', 'orsAaService', 'orsMessagingService', 'lists', 'weathercheck', ($timeout, orsObjectsFactory, orsUtilsService, orsRequestService, orsRouteService, orsAaService, orsMessagingService, lists, weathercheck) => {
        ...
        orsSettingsFactory.updateWaypoint = (idx, address, pos, fireRequest = true) => {
            ...
            orsSettingsFactory[currentSettingsObj].getValue()
                .waypoints[idx]._latlng = pos;
            orsSettingsFactory[currentSettingsObj].getValue()
                .waypoints[idx]._address = address;
            /** Fire a new request. */
            if (fireRequest) orsSettingsFactory[currentSettingsObj].onNext(orsSettingsFactory[currentSettingsObj].getValue());
